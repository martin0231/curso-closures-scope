...
firstName = 'Romen';//Asignacion
console.log(firstName);          //Mostramos

var lastName = 'Ter Gazarian'   //Declaramos y asignamos
lastName = 'Pichulo'            //Reasignacion

var secondName = 'Romen'
var secondName = 'Pichulo'      //asignamos y redeclaramos
...
const vehicles = [];
vehicles.push('🏎️')           //no estamos reassignando ni redeclarando, usamos metodos de arreglos
